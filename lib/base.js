...
Record = function(attempts, bargein, beep, choices, format, maxSilence, maxTime, method, minConfidence, name, required, say, timeout, transcription, url, password, username, allowSignals, interdigitTimeout) {
    this.attempts = attempts;
    this.bargein = bargein;
    this.beep = beep;
    this.choices = serializeProperty(choices);
...
Say = function(value, as, name, required, voice, allowSignals) {
    this.value = value;
    this.as = as;
    this.name = name;
    this.required = required;
...
Transfer = function(to, answerOnMedia, choices, from, headers, name, on, required, timeout, allowSignals, interdigitTimeout, ringRepeat) {
    this.to = to;
    this.answerOnMedia = answerOnMedia;
    this.choices = serializeProperty(choices);
    this.from = from;
