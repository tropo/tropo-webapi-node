...
TropoWebAPI.prototype.record = function(attempts, bargein, beep, choices, format, maxSilence, maxTime, method, minConfidence, name, required, say, timeout, transcription, url, password, username, allowSignals, interdigitTimeout) {
    var record = new base.Record(attempts, bargein, beep, choices, format, maxSilence, maxTime, method, minConfidence, name, required, say, timeout, transcription, url, password, username, allowSignals, interdigitTimeout);
...
TropoWebAPI.prototype.say = function(value, as, name, required, voice, allowSignals) {
    var say = new base.Say(value, as, name, required, voice, allowSignals);
...
TropoWebAPI.prototype.transfer = function(to, answerOnMedia, choices, from, headers, name, on, required, timeout, allowSignals, interdigitTimeout, ringRepeat) {
    var transfer = new base.Transfer(to, answerOnMedia, choices, from, headers, name, on, required, timeout, allowSignals, interdigitTimeout, ringRepeat);
